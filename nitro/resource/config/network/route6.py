...
class route6(base_resource) :
	...
	@property
	def network(self) :
		r"""IPv6 network address for which to add a route entry to the routing table of the NetScaler appliance.
		"""
		try :
	...
	@property
	def vlan(self) :
		r"""Integer value that uniquely identifies a VLAN through which the NetScaler appliance forwards the packets for this route.<br/>Default value: 0<br/>Maximum length =  4094.
		"""
		try :
			return self._vlan
		except Exception as e:
	...
	@property
	def vxlan(self) :
		r"""Integer value that uniquely identifies a VXLAN through which the NetScaler appliance forwards the packets for this route.<br/>Minimum length =  1<br/>Maximum length =  16777215.
		"""
		try :
			return self._vxlan
		except Exception as e:
	...
	@property
	def monitor(self) :
		r"""Name of the monitor, of type ND6 or PING, configured on the NetScaler appliance to monitor this route.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def routetype(self) :
		r"""Type of IPv6 routes to remove from the routing table of the NetScaler appliance.<br/>Possible values = CONNECTED, STATIC, DYNAMIC, OSPF, ISIS, BGP, RIP, ND-RA-ROUTE, FIB6.
		"""
		try :
