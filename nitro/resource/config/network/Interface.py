...
class Interface(base_resource) :
	...
	def reqflowcontrol(self) :
		r"""Requested flow control setting for this interface.<br/>Possible values = OFF, RX, TX, RXTX.
		"""
		try :
	...
	@property
	def actflowctl(self) :
		r"""Actual flow control setting for this interface.<br/>Possible values = OFF, RX, TX, RXTX.
		"""
		try :
	...
	@property
	def conndistr(self) :
		r"""Connection distribution setting on this interface.<br/>Possible values = DISABLED, ENABLED.
		"""
		try :
	...
	@property
	def macdistr(self) :
		r"""MAC distribution setting on this interface.<br/>Possible values = SOURCE, DESTINATION, BOTH.
		"""
		try :
