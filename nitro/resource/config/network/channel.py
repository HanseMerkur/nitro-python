...
class channel(base_resource) :
	...
	@property
	def lamac(self) :
		r"""Specifies a MAC address for the LA channels configured in NetScaler virtual appliances (VPX). This MAC address is persistent after each reboot. 
	...
	def bandwidthhigh(self) :
		r"""High threshold value for the bandwidth usage of the LA channel, in Mbps. The NetScaler appliance generates an SNMP trap message when the bandwidth usage of the LA channel is greater than or equal to the specified high threshold value.<br/>Maximum length =  160000.
		"""
		try :
	...
	@property
	def unit(self) :
		r"""Unit number of the channel. This is an internal reference number that the NetScaler uses to identify the channel.
		"""
		try :
			return self._unit
		except Exception as e:
	...
	@property
	def reqspeed(self) :
		r"""Requested speed setting for this channel. Since no media are associated with LA, this speed is used to determine the threshold for the slave interfaces. If the speed of the member interface is less than the requested speed, that interface is considered inactive.<br/>Possible values = AUTO, 10, 100, 1000, 10000, 40000.
		"""
		try :
	...
	def reqflowcontrol(self) :
		r"""Requested flow control setting for this channel. Since no media are associated with LA, the displayed values carry no significance.<br/>Possible values = OFF, RX, TX, RXTX.
		"""
		try :
	...
	@property
	def actspeed(self) :
		r"""Actual speed setting for this channel.<br/>Possible values = AUTO, 10, 100, 1000, 10000, 40000.
		"""
		try :
	...
	@property
	def actflowctl(self) :
		r"""Actual flow control setting for this channel.<br/>Possible values = OFF, RX, TX, RXTX.
		"""
		try :
	...
	@property
	def rxpackets(self) :
		r"""Number of bytes received by all the slave interfaces of the channel since the NetScaler appliance was started or the interface statistics were cleared.
		"""
		try :
	...
	@property
	def rxbytes(self) :
		r"""Number of packets received by all member interfaces since the NetScaler appliance was started or the interface statistics were cleared.
		"""
		try :
	...
	@property
	def rxerrors(self) :
		r"""Number of inbound packets dropped by the hardware of the slave interfaces since the NetScaler appliance was started or the interface statistics were cleared. Possible causes of dropped packets are CRC, length (undersize or oversize), and alignment errors.
		"""
		try :
	...
	@property
	def txpackets(self) :
		r"""Number of packets transmitted by slave interfaces of a channel since the NetScaler appliance was started or the interface statistics were cleared.
		"""
		try :
	...
	@property
	def txbytes(self) :
		r"""Number of bytes transmitted by slave interfaces of a channel since the NetScaler appliance was started or the interface statistics were cleared.
		"""
		try :
	...
	@property
	def txerrors(self) :
		r"""Number of outbound packets dropped by the hardware of a channel's slave interfaces since the NetScaler appliance was started or the interface statistics were cleared. Possible causes of dropped packets are length (undersize or oversize) errors and lack of resources.
		"""
		try :
	...
	def lacptimeout(self) :
		r"""Time to wait for the LACPDU.  If a LACPDU is not received within this interval, the NetScaler markes the link partner port as DOWN. Possible values: Long and Short. Long lacptimeout is 90 sec and Short LACP timeout is 3 sec.<br/>Possible values = LONG, SHORT.
		"""
		try :
