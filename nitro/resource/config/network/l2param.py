...
class l2param(base_resource) :
	...
	@property
	def bdgsetting(self) :
		r"""Bridging settings for C2C behavior.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def macmodefwdmypkt(self) :
		r""" MAC mode vserver forward packets destined to VIPs.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def usemymac(self) :
		r"""Set/reset cfg_use_my_mac .<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def proxyarp(self) :
		r"""Set/reset cfg_proxy_arp_dr .<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def skipproxyingbsdtraffic(self) :
		r"""Enable the proxying of FreeBSD traffic.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def stopmacmoveupdate(self) :
		r"""Stop propagation of server mac change to natpcbs.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
