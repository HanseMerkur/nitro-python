...
class route(base_resource) :
	...
	@property
	def network(self) :
		r"""IPv4 network address for which to add a route entry in the routing table of the NetScaler appliance.
		"""
		try :
	...
	@property
	def monitor(self) :
		r"""Name of the monitor, of type ARP or PING, configured on the NetScaler appliance to monitor this route.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def routetype(self) :
		r"""Protocol used by routes that you want to remove from the routing table of the NetScaler appliance.<br/>Possible values = CONNECTED, STATIC, DYNAMIC, OSPF, ISIS, RIP, BGP, VPATH.
		"""
		try :
