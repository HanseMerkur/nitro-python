...
class ipv6(base_resource) :
	...
	@property
	def ralearning(self) :
		r"""Enable the NetScaler appliance to learn about various routes from Router Advertisement (RA) and Router Solicitation (RS) messages sent by the routers.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def routerredirection(self) :
		r"""Enable the NetScaler appliance to do Router Redirection.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def ndbasereachtime(self) :
		r"""Base reachable time of the Neighbor Discovery (ND6) protocol. The time, in milliseconds, that the NetScaler appliance assumes an adjacent device is reachable after receiving a reachability confirmation.<br/>Default value: 30000<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def dodad(self) :
		r"""Enable the NetScaler appliance to do Duplicate Address
