...
class l3param(base_resource) :
	...
	def tnlpmtuwoconn(self) :
		r"""Enable external loopback.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def icmperrgenerate(self) :
		r"""Enable/Disable fragmentation required icmp error generation, before encapsulating a packet with vPath header. This knob is only functional for vPath Environment.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
