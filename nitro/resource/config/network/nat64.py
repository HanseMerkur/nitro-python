...
class nat64(base_resource) :
	...
	@property
	def netprofile(self) :
		r"""Name of the configured netprofile. The NetScaler appliance selects one of the IP address in the netprofile as the source IP address of the translated IPv4 packet to be sent to the IPv4 server.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
