...
class vpath(base_resource) :
	...
	@property
	def destip(self) :
		r"""This is the destination ip, where vPath encapsulated packets needs to be sent.<br/>Minimum length =  1.
		"""
		try :
			return self._destip
		except Exception as e:
	...
	@property
	def netmask(self) :
		r"""Subnet mask associated with the destination network.
		"""
		try :
	...
	@property
	def gateway(self) :
		r"""Next hop gateway to reach the destination address.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete vpath.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the vpath resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = vpath()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of vpath resources.
	...
	def count(cls, client) :
		r""" Use this API to count the vpath resources configured on NetScaler.
		"""
		try :
			obj = vpath()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of vpath resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpath()
