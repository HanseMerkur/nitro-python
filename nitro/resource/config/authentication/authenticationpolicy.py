...
class authenticationpolicy(base_resource) :
	...
	@property
	def rule(self) :
		r"""Name of the NetScaler named rule, or a default syntax expression, that the policy uses to determine whether to attempt to authenticate the user with the AUTHENTICATION server.
		"""
		try :
			return self._rule
		except Exception as e:
	...
	def policysubtype(self) :
		r""".<br/>Possible values = LOCAL, RADIUS, LDAP, TACACS, CERT, NEGOTIATE, SAML, PROFILE, DFA, SAMLIDP, WEBAUTH, OAUTH, NO_AUTHN.
		"""
		try :
