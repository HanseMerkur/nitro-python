...
class authenticationsamlaction(base_resource) :
	...
	def samlidpcertname(self) :
		r"""Name of the SAML server as given in that server's SSL certificate.<br/>Minimum length =  1.
		"""
		try :
	...
	def samlrejectunsignedassertion(self) :
		r"""Reject unsigned SAML assertions.<br/>Default value: ON<br/>Possible values = ON, OFF, STRICT.
		"""
		try :
	...
	@property
	def attribute1(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute1.
		"""
		try :
	...
	@property
	def attribute2(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute2.
		"""
		try :
	...
	@property
	def attribute3(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute3.
		"""
		try :
	...
	@property
	def attribute4(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute4.
		"""
		try :
	...
	@property
	def attribute5(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute5.
		"""
		try :
	...
	@property
	def attribute6(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute6.
		"""
		try :
	...
	@property
	def attribute7(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute7.
		"""
		try :
	...
	@property
	def attribute8(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute8.
		"""
		try :
	...
	@property
	def attribute9(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute9.
		"""
		try :
	...
	def attribute10(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute10.
		"""
		try :
	...
	def attribute11(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute11.
		"""
		try :
	...
	def attribute12(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute12.
		"""
		try :
	...
	def attribute13(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute13.
		"""
		try :
	...
	def attribute14(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute14.
		"""
		try :
	...
	def attribute15(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute15.
		"""
		try :
	...
	def attribute16(self) :
		r"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute16.
		"""
		try :
	...
	@property
	def logouturl(self) :
		r"""SingleLogout URL on IdP to which logoutRequest will be sent on Netscaler session cleanup.
		"""
		try :
	...
	def artifactresolutionserviceurl(self) :
		r"""URL of the Artifact Resolution Service on IdP to which Netscaler will post artifact to get actual SAML token.
		"""
		try :
	...
	@property
	def skewtime(self) :
		r"""This option specifies the allowed clock skew in number of minutes that Netscaler ServiceProvider allows on an incoming assertion. For example, if skewTime is 10, then assertion would be valid from (current time - 10) min to (current time + 10) min, ie 20min in all.<br/>Default value: 5.
		"""
		try :
