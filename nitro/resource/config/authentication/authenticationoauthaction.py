...
class authenticationoauthaction(base_resource) :
	...
	def authorizationendpoint(self) :
		r"""Authorization endpoint/url to which unauthenticated user will be redirected. Netscaler appliance redirects user to this endpoint by adding query parameters including clientid.
		"""
		try :
	...
	@property
	def clientid(self) :
		r"""Unique identity of the client/user who is getting authenticated. Authorization server infers client configuration using this ID.
		"""
		try :
	...
	def clientsecret(self) :
		r"""Secret string established by user and authorization server.
		"""
		try :
