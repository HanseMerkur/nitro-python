...
class authenticationsamlidpprofile(base_resource) :
	...
	def samlidpcertname(self) :
		r"""Name of the signing authority as given in the SAML server's SSL certificate. This certificate is used to sign the SAMLResposne that is sent to Relying Party or Service Provider after successful authentication.<br/>Minimum length =  1.
		"""
		try :
	...
	def rejectunsignedrequests(self) :
		r"""Option to Reject unsigned SAML Requests.<br/>Default value: ON<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def encryptassertion(self) :
		r"""Option to encrypt assertion when Netscaler IDP sends one.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def serviceproviderid(self) :
		r"""Unique identifier of the Service Provider that sends SAML Request. Netscaler will ensure that the Issuer of the SAML Request matches this URI.<br/>Minimum length =  1.
		"""
		try :
