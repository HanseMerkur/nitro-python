...
class authenticationwebauthaction(base_resource) :
	...
	@property
	def serverport(self) :
		r"""Port on which the web server accepts connections.<br/>Minimum length =  1<br/>Range 1 - 65535.
		"""
		try :
	...
	def fullreqexpr(self) :
		r"""Exact HTTP request, in the form of a default syntax expression, which the NetScaler appliance sends to the authentication server.
