...
class authenticationnegotiateaction(base_resource) :
	...
	@property
	def domain(self) :
		r"""Domain name of the AD KDC server.<br/>Minimum length =  1.
		"""
		try :
			return self._domain
		except Exception as e:
	...
	@property
	def domainuser(self) :
		r"""User name that the NetScaler appliance uses to join the AD KDC server domain. 
	...
	def domainuserpasswd(self) :
		r"""Password that the NetScaler appliance uses to join the AD KDC server domain.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def keytab(self) :
		r"""The path to the keytab file.<br/>Minimum length =  1.
		"""
		try :
			return self._keytab
		except Exception as e:
	...
	@property
	def ntlmpath(self) :
		r"""The path to the site that is enabled for NTLM authentication, including FQDN of the server.<br/>Minimum length =  1.
		"""
		try :
