...
class appflowparam(base_resource) :
	...
	def securityinsightrecordinterval(self) :
		r"""Interval, in seconds, at which to send security insight flow records to the configured collectors.<br/>Default value: 60<br/>Minimum length =  60<br/>Maximum length =  3600.
		"""
		try :
