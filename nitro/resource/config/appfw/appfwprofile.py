...
class appfwprofile(base_resource) :
	...
	def defaultfieldformatmaxlength(self) :
		r"""Maximum length, in characters, for data entered into a field that is assigned the default field type.<br/>Default value: 65535<br/>Minimum length =  1<br/>Maximum length =  65535.
		"""
		try :
	...
	@property
	def creditcard(self) :
		r"""Credit card types that the application firewall should protect.<br/>Possible values = visa, mastercard, discover, amex, jcb, dinersclub.
		"""
		try :
	...
	def creditcardmaxallowed(self) :
		r"""Maximum number of credit card numbers that can appear on a web page served by your protected web sites. Pages that contain more credit card numbers are blocked if 'block' action is enabled. It doesn't apply to x-out.<br/>Maximum length =  255.
		"""
		try :
	...
	def postbodylimit(self) :
		r"""Maximum allowed HTTP post body size, in bytes.<br/>Default value: 20000000<br/>Maximum length =  1000000000.
		"""
		try :
