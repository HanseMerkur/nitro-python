...
class appfwpolicy(base_resource) :
	...
	@property
	def rule(self) :
		r"""Name of the NetScaler named rule, or a NetScaler default syntax expression, that the policy uses to determine whether to filter the connection through the application firewall with the designated profile.
		"""
		try :
			return self._rule
		except Exception as e:
