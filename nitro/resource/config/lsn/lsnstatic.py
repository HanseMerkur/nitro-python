...
class lsnstatic(base_resource) :
	...
	def transportprotocol(self) :
		r"""Protocol for the LSN mapping entry.<br/>Possible values = TCP, UDP, ICMP.
		"""
		try :
	...
	@property
	def subscrport(self) :
		r"""Port of the LSN subscriber for the LSN mapping entry.<br/>Maximum length =  65535.
		"""
		try :
	...
	@property
	def natport(self) :
		r"""NAT port for this LSN mapping entry.
		"""
		try :
