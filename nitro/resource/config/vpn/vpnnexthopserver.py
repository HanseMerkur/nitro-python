...
class vpnnexthopserver(base_resource) :
	...
	@property
	def name(self) :
		r"""Name for the NetScaler Gateway appliance in the first DMZ.<br/>Minimum length =  1<br/>Maximum length =  32.
		"""
		try :
			return self._name
	...
	@property
	def nexthopip(self) :
		r"""IP address of the NetScaler Gateway proxy in the second DMZ.
		"""
		try :
	...
	def nexthopfqdn(self) :
		r"""FQDN of the NetScaler Gateway proxy in the second DMZ.<br/>Minimum length =  1.
		"""
		try :
	...
	def nexthopport(self) :
		r"""Port number of the NetScaler Gateway proxy in the second DMZ.<br/>Minimum length =  1<br/>Maximum length =  65535.
		"""
		try :
