...
class vpnvserver(base_resource) :
	...
	@property
	def name(self) :
		r"""Name for the NetScaler Gateway virtual server. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters. Can be changed after the virtual server is created.
	...
	def servicetype(self) :
		r"""Protocol used by the NetScaler Gateway virtual server.<br/>Default value: SSL<br/>Possible values = SSL.
		"""
		try :
	...
	@property
	def ipv46(self) :
		r"""IPv4 or IPv6 address of the NetScaler Gateway virtual server. Usually a public IP address. User devices send connection requests to this IP address.<br/>Minimum length =  1.
		"""
		try :
			return self._ipv46
		except Exception as e:
	...
	@property
	def range(self) :
		r"""Range of NetScaler Gateway virtual server IP addresses. The consecutively numbered range of IP addresses begins with the address specified by the IP Address parameter. 
	...
	@property
	def port(self) :
		r"""TCP port on which the virtual server listens.<br/>Range 1 - 65535.
		"""
		try :
			return self._port
		except Exception as e:
	...
	def authentication(self) :
		r"""Require authentication for users connecting to NetScaler Gateway.<br/>Default value: ON<br/>Possible values = ON, OFF.
		"""
		try :
	...
	@property
	def dtls(self) :
		r"""This option starts/stops the turn service on the vserver.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
			return self._dtls
		except Exception as e:
	...
	def listenpolicy(self) :
		r"""String specifying the listen policy for the NetScaler Gateway virtual server. Can be either a named expression or a default syntax expression. The NetScaler Gateway virtual server processes only the traffic for which the expression evaluates to true.<br/>Default value: "none".
		"""
		try :
	...
	@property
	def newname(self) :
		r"""New name for the NetScaler Gateway virtual server. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters. 
		The following requirement applies only to the NetScaler CLI:
		If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my server" or 'my server').<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def priority(self) :
		r"""The priority, if any, of the VPN virtual server policy.
		"""
		try :
