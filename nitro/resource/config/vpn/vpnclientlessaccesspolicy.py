...
class vpnclientlessaccesspolicy(base_resource) :
	...
	@property
	def rule(self) :
		r"""Expression, or name of a named expression, specifying the traffic that matches the policy. Can be written in either default or classic syntax. 
	...
	@property
	def builtin(self) :
		r"""Flag to determine if vpn clientless rewrite policy is built-in or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
