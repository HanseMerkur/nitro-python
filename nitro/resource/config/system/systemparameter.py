...
class systemparameter(base_resource) :
	...
	def strongpassword(self) :
		r"""Option to enable/disable strong password. When this is enabled, system user password should contain atleast one lower case character, one upper case character, one numeric character and one special character from the set (!, @, #, (, ), $, %, ^, &, *).<br/>Default value: disabled<br/>Possible values = enableall, enablelocal, disabled.
		"""
		try :
