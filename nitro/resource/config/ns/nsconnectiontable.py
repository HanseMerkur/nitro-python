...
class nsconnectiontable(base_resource) :
	...
	@property
	def sourceport(self) :
		r"""Source port of the connection.<br/>Range 1 - 65535.
		"""
		try :
	...
	@property
	def destport(self) :
		r"""Destination port of the connection.<br/>Range 1 - 65535.
		"""
		try :
	...
	def linksourceport(self) :
		r"""Source port of the link connection.<br/>Range 1 - 65535.
		"""
		try :
	...
	def linkdestport(self) :
		r"""Destination port of the link connection.<br/>Range 1 - 65535.
		"""
		try :
	...
	@property
	def httpreqver(self) :
		r"""current HTTP request version on the connection.<br/>Possible values = HTTP_1_0, HTTP_1_1, HTTP_0_9, RTSP_1_0, SIP_2_0, VPN_ICA_SOCKS, VPN_ICA_CGP.
		"""
		try :
