...
class nsip6(base_resource) :
	...
	@property
	def hostroute(self) :
		r"""Advertise a route for the VIP6 address by using the dynamic routing protocols running on the NetScaler appliance.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
