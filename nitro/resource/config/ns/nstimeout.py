...
class nstimeout(base_resource) :
	...
	@property
	def zombie(self) :
		r"""Interval, in seconds, at which the NetScaler zombie cleanup process must run. This process cleans up inactive TCP connections.<br/>Default value: 120<br/>Minimum length =  1<br/>Maximum length =  600.
		"""
		try :
			return self._zombie
