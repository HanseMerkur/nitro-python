...
class nspartition(base_resource) :
	...
	def maxbandwidth(self) :
		r"""Maximum bandwidth in Kbps, permitted on this partition.<br/>Default value: 10240.
		"""
		try :
	...
	def minbandwidth(self) :
		r"""Minimum bandwidth in Kbps, permitted on this partition.<br/>Default value: 10240.
		"""
		try :
	...
	@property
	def maxconn(self) :
		r"""Maximum number of connections permitted on this partition.<br/>Default value: 1024.
		"""
		try :
	...
	def maxmemlimit(self) :
		r"""Maximum memory allowed for this partition in megabytes.<br/>Default value: 10<br/>Minimum length =  5.
		"""
		try :
