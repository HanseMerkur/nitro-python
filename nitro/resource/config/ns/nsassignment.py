...
class nsassignment(base_resource) :
	...
	@property
	def variable(self) :
		r"""Left hand side of the assigment, of the form $variable-name (for a singleton variabled) or $variable-name[key-expression], where key-expression is a default syntax expression that evaluates to a text string and provides the key to select a map entry.
		"""
		try :
	...
	@property
	def set(self) :
		r"""Right hand side of the assignment. The default syntax expression is evaluated and assigned to theleft hand variable.
		"""
		try :
			return self._set
		except Exception as e:
	...
	@property
	def Add(self) :
		r"""Right hand side of the assignment. The default syntax expression is evaluated and added to the left hand variable.
		"""
		try :
			return self._Add
		except Exception as e:
	...
	@property
	def sub(self) :
		r"""Right hand side of the assignment. The default syntax expression is evaluated and subtracted from the left hand variable.
		"""
		try :
			return self._sub
		except Exception as e:
	...
	@property
	def append(self) :
		r"""Right hand side of the assignment. The default syntax expression is evaluated and appended to the left hand variable.
		"""
		try :
			return self._append
		except Exception as e:
