...
class nsvariable(base_resource) :
	...
	@property
	def name(self) :
		r"""Variable name.  This follows the same syntax rules as other default syntax expression entity names:
	...
	@property
	def init(self) :
		r"""Initialization value for values in this variable. Default: 0 for ulong, NULL for text.
		"""
		try :
			return self._init
		except Exception as e:
