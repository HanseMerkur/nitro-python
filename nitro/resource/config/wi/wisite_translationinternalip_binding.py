...
class wisite_translationinternalip_binding(base_resource) :
	...
	def translationexternalport(self) :
		r"""External port number associated with the server's port number.<br/>Range 1 - 65535.
		"""
		try :
	...
	def translationinternalport(self) :
		r"""Port number of the server for which you want to associate an external port.  (Clients access the server through the associated external address and port.).<br/>Range 1 - 65535.
		"""
		try :
