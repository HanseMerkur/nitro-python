...
class wisite_farmname_binding(base_resource) :
	...
	@property
	def transport(self) :
		r"""Transport protocol to use for transferring data, related to the Web Interface site, between the NetScaler appliance and the XML service.<br/>Possible values = HTTP, HTTPS, SSLRELAY.
		"""
		try :
	...
	def sslrelayport(self) :
		r"""TCP port at which the XenApp or XenDesktop servers listenfor SSL Relay traffic from the NetScaler appliance. This parameter is required if you have set SSL Relay as the transport protocol. 
