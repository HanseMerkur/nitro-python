...
class cacheforwardproxy(base_resource) :
	...
	@property
	def ipaddress(self) :
		r"""IP address of the NetScaler appliance or a cache server for which the cache acts as a proxy. Requests coming to the NetScaler with the configured IP address are forwarded to the particular address, without involving the Integrated Cache in any way.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def port(self) :
		r"""Port on the NetScaler appliance or a server for which the cache acts as a proxy.<br/>Minimum length =  1<br/>Range 1 - 65535.
		"""
		try :
			return self._port
		except Exception as e:
