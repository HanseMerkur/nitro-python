...
class cachecontentgroup(base_resource) :
	...
	@property
	def memlimit(self) :
		r"""Maximum amount of memory that the cache can use. The effective limit is based on the available memory of the NetScaler appliance.<br/>Default value: 65536.
		"""
		try :
	...
	@property
	def disklimit(self) :
		r"""Maximum amount of disk that the cache can use. The effective limit is based on the available memory of the NetScaler appliance.<br/>Default value: 0.
		"""
		try :
