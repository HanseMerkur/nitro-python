...
class ntpserver(base_resource) :
	...
	def preferredntpserver(self) :
		r"""Preferred NTP server. The NetScaler appliance chooses this NTP server for time synchronization among a set of correctly operating hosts.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
