...
class cmpaction(base_resource) :
	...
	def addvaryheader(self) :
		r"""Control insertion of the Vary header in HTTP responses compressed by NetScaler. Intermediate caches store different versions of the response for different values of the headers present in the Vary response header.<br/>Default value: GLOBAL<br/>Possible values = GLOBAL, DISABLED, ENABLED.
		"""
		try :
