...
class responderaction(base_resource) :
	...
	def reasonphrase(self) :
		r"""Expression specifying the reason phrase of the HTTP response. The reason phrase may be a string literal with quotes or a PI expression. For example: "Invalid URL: " + HTTP.REQ.URL.
		"""
		try :
	...
	@property
	def builtin(self) :
		r"""Flag to determine whether responder action is built-in or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
