...
class dnspolicy(base_resource) :
	...
	@property
	def rule(self) :
		r"""Expression against which DNS traffic is evaluated. Written in the default syntax.
		Note:
	...
	@property
	def builtin(self) :
		r"""Flag to determine whether DNS policy is default or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
