...
class sslprofile(base_resource) :
	...
	@property
	def dhcount(self) :
		r"""Number of interactions, between the client and the NetScaler appliance, after which the DH private-public pair is regenerated. A value of zero (0) specifies infinite use (no refresh).
	...
	def sesstimeout(self) :
		r"""The Session timeout value in seconds.<br/>Default value: 120<br/>Maximum length =  0xFFFFFFFE.
		"""
		try :
	...
	def cleartextport(self) :
		r"""Port on which clear-text data is sent by the appliance to the server. Do not specify this parameter for SSL offloading with end-to-end encryption.<br/>Range 1 - 65535.
		"""
		try :
	...
	@property
	def builtin(self) :
		r"""Flag to determine whether ssl profile is built-in or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
