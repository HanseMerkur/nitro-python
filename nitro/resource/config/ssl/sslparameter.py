...
class sslparameter(base_resource) :
	...
	def svctls1112disable(self) :
		r"""Disable TLS 1.1 and 1.2 for dynamic and VPN created services.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def montls1112disable(self) :
		r"""Disable TLS 1.1 and 1.2 for secure (https) monitors bound to SSL_BRIDGE services.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
