...
class sslvserver(base_resource) :
	...
	def cleartextport(self) :
		r"""Port on which clear-text data is sent by the appliance to the server. Do not specify this parameter for SSL offloading with end-to-end encryption.<br/>Default value: 0.
		"""
		try :
	...
	def nonfipsciphers(self) :
		r"""State of usage of non-FIPS approved ciphers. Valid only for an SSL service bound with a FIPS key and certificate.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def cipherdetails(self) :
		r"""Display details of the individual ciphers bound to the SSL virtual server.
		"""
		try :
