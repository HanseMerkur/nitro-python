...
class sslservicegroup(base_resource) :
	...
	@property
	def dhcount(self) :
		r"""The  refresh  count  for  the re-generation of DH public-key and private-key from the DH parameter.
		"""
		try :
	...
	@property
	def ersacount(self) :
		r"""The  refresh  count  for the re-generation of RSA public-key and private-key pair.
		"""
		try :
	...
	def cleartextport(self) :
		r"""The port on the back-end web-servers where the clear-text data is sent by system. Use this setting for the wildcard IP based SSL Acceleration configuration (*:443).<br/>Range 1 - 65535.
		"""
		try :
