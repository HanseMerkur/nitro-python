...
class snmpalarm(base_resource) :
	...
	def thresholdvalue(self) :
		r"""Value for the high threshold. The NetScaler appliance generates an SNMP trap message when the value of the attribute associated with the alarm is greater than or equal to the specified high threshold value.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def state(self) :
		r"""Current state of the SNMP alarm. The NetScaler appliance generates trap messages only for SNMP alarms that are enabled. Some alarms are enabled by default, but you can disable them.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._state
		except Exception as e:
	...
	@property
	def logging(self) :
		r"""Logging status of the alarm. When logging is enabled, the NetScaler appliance logs every trap message that is generated for this alarm.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
