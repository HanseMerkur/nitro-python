...
class configstatus(base_resource) :
	...
	@property
	def consistent(self) :
		r"""State of packet engines.<br/>Possible values = YES, NO.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the configstatus resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = configstatus()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of configstatus resources.
	...
	def count(cls, client) :
		r""" Use this API to count the configstatus resources configured on NetScaler.
		"""
		try :
			obj = configstatus()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of configstatus resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = configstatus()
