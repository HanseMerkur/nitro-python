...
class nstrace(base_resource) :
	...
	@property
	def pernic(self) :
		r"""Use separate trace files for each interface. Works only with tcpdump format.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._pernic
		except Exception as e:
	...
	@property
	def filesize(self) :
		r"""File size, in MB, treshold for rollover.
