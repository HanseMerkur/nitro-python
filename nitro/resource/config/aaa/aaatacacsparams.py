...
class aaatacacsparams(base_resource) :
	...
	def authtimeout(self) :
		r"""Maximum number of seconds that the NetScaler appliance waits for a response from the TACACS+ server.<br/>Default value: 3<br/>Minimum length =  1.
		"""
		try :
	...
	def tacacssecret(self) :
		r"""Key shared between the TACACS+ server and clients. Required for allowing the NetScaler appliance to communicate with the TACACS+ server.<br/>Minimum length =  1.
		"""
		try :
