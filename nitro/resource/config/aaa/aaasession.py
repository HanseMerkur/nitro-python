...
class aaasession(base_resource) :
	...
	@property
	def publicport(self) :
		r"""Client's public port.<br/>Range 1 - 65535.
		"""
		try :
	...
	@property
	def port(self) :
		r"""NetScaler's port.<br/>Range 1 - 65535.
		"""
		try :
			return self._port
		except Exception as e:
	...
	def privateport(self) :
		r"""Client's private/mapped port.<br/>Range 1 - 65535.
		"""
		try :
	...
	@property
	def destport(self) :
		r"""Destination port.<br/>Range 1 - 65535.
		"""
		try :
