...
class lbvserver_auditsyslogpolicy_binding(base_resource) :
	...
	@property
	def bindpoint(self) :
		r"""Bind point to which to bind the policy. Applicable only to compression, rewrite, and cache policies.
		"""
		try :
	...
	@property
	def labeltype(self) :
		r"""Type of policy label to invoke. Applicable only to rewrite and cache policies. Available settings function as follows:
