...
class lbwlm(base_resource) :
	...
	@property
	def port(self) :
		r"""The port of the WLM.<br/>Range 1 - 65535.
		"""
		try :
			return self._port
		except Exception as e:
	...
	@property
	def katimeout(self) :
		r"""The idle time period after which NS would probe the WLM. The value ranges from 1 to 1440 minutes.<br/>Default value: 2<br/>Maximum length =  1440.
		"""
		try :
