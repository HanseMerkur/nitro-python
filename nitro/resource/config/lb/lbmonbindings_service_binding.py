...
class lbmonbindings_service_binding(base_resource) :
	...
	def servicetype(self) :
		r"""The type of service.<br/>Possible values = HTTP, FTP, TCP, UDP, SSL, SSL_BRIDGE, SSL_TCP, DTLS, NNTP, RPCSVR, DNS, ADNS, SNMP, RTSP, DHCPRA, ANY, SIP_UDP, SIP_TCP, SIP_SSL, DNS_TCP, ADNS_TCP, MYSQL, MSSQL, ORACLE, RADIUS, RADIUSListener, RDP, DIAMETER, SSL_DIAMETER, TFTP, SMPP, PPTP, GRE, SYSLOGTCP, SYSLOGUDP, FIX.
		"""
		try :
	...
	@property
	def port(self) :
		r"""The port of the service.<br/>Range 1 - 65535.
		"""
		try :
			return self._port
		except Exception as e:
