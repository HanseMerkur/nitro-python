...
class protocolicmp_stats(base_resource) :
	...
	def icmptotnoudpconn(self) :
		r"""ICMP Need Fragmentation error messages received for UDP packets. The state of the connection for these packets is not maintained on the NetScaler.
		"""
		try :
	...
	def icmptotnotcpconn(self) :
		r"""ICMP Need Fragmentation error messages received for TCP packets. The state of the connection for these packets is not maintained on the NetScaler.
		"""
		try :
