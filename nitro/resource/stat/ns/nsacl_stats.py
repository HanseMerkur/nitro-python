...
class nsacl_stats(base_resource) :
	...
	@property
	def aclname(self) :
		r"""Name of the extended ACL rule whose statistics you want the NetScaler appliance to display.<br/>Minimum length =  1.
		"""
		try :
	...
	def aclname(self, aclname) :
		r"""Name of the extended ACL rule whose statistics you want the NetScaler appliance to display.
		"""
		try :
	...
	def acltotpktsallowed(self) :
		r"""Packets matching ACLs with processing mode set to ALLOW. NetScaler processes these packets.
		"""
		try :
