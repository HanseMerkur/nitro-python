...
class nsacl6_stats(base_resource) :
	...
	@property
	def acl6name(self) :
		r"""Name of the ACL6 rule whose statistics you want the NetScaler appliance to display.<br/>Minimum length =  1.
		"""
		try :
	...
	def acl6name(self, acl6name) :
		r"""Name of the ACL6 rule whose statistics you want the NetScaler appliance to display.
		"""
		try :
	...
	def acl6totpktsallowed(self) :
		r"""Packets matching IPv6 ACLs with processing mode set to ALLOW. NetScaler processes these packets.
		"""
		try :
