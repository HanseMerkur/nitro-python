...
class ns_stats(base_resource) :
	...
	def mgmtcpuusagepcnt(self) :
		r"""Management CPU utilization percentage.
		"""
		try :
	...
	@property
	def totrxmbits(self) :
		r"""Number of megabytes received by the NetScaler appliance.
		"""
		try :
	...
	@property
	def tottxmbits(self) :
		r"""Number of megabytes transmitted by the NetScaler appliance.
		"""
		try :
