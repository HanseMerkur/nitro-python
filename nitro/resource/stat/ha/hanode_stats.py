...
class hanode_stats(base_resource) :
	...
	def hacurstatus(self) :
		r"""Whether a NetScaler appliance is configured for high availability. Possible values are YES and NO. If the value is NO, the high availability statistics below are invalid.
		"""
		try :
