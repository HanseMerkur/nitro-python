...
class pq_stats(base_resource) :
	...
	def pqtotalpolicymatches(self) :
		r"""Number of times the Netscaler appliance matched an incoming request using any priority queuing policy.
		"""
		try :
	...
	def pqpriority1requests(self) :
		r"""Number of priority 1 requests that the Netscaler appliance received.
		"""
		try :
	...
	def pqpriority3requests(self) :
		r"""Number of priority 3 requests that the Netscaler appliance received.
		"""
		try :
	...
	def pqpriority2requests(self) :
		r"""Number of priority 2 requests that the Netscaler appliance received.
		"""
		try :
	...
	def pqtotalthresholdfailed(self) :
		r"""Number of times the Netscaler appliance failed to match an incoming request to any of priority queing policy.
		"""
		try :
