...
class aaa_stats(base_resource) :
	...
	def aaacuricasessions(self) :
		r"""Count of current ICA only sessions.
		"""
		try :
	...
	def aaacuricaonlyconn(self) :
		r"""Count of current ICA only connections.
		"""
		try :
	...
	def aaacuricaconn(self) :
		r"""Count of current ICA connections.
		"""
		try :
	...
	def aaacursessions(self) :
		r"""Count of current AAA sessions.
		"""
		try :
