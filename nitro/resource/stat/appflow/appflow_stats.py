...
class appflow_stats(base_resource) :
	...
	def appflowtotalnotxoctets(self) :
		r"""The total number of AppFlow (IPFIX) octets that the NetScaler has not transmitted.
		"""
		try :
	...
	def appflowtotaltxmessagess(self) :
		r"""The total number of AppFlow (IPFIX) messages that the NetScaler has transmitted.
		"""
		try :
	...
	def appflowtotalignpacketss(self) :
		r"""The total number of packets that the NetScaler has ignored for AppFlow (IPFIX).
		"""
		try :
	...
	def appflowtotalflows(self) :
		r"""The total number of AppFlow (IPFIX) flows that the NetScaler has transmitted.
		"""
		try :
	...
	def appflowtotalnotxflows(self) :
		r"""The total number of AppFlow (IPFIX) flows that the NetScaler has not transmitted.
		"""
		try :
	...
	def appflowtotalnotxpackets(self) :
		r"""The total number of AppFlow (IPFIX) packets that the NetScaler has not transmitted.
		"""
		try :
	...
	def appflowtotalignoctets(self) :
		r"""The total number of octets that the NetScaler has ignored for AppFlow (IPFIX).
		"""
		try :
	...
	def appflowtotaltxoctets(self) :
		r"""The total number of AppFlow (IPFIX) octets that the NetScaler has transmitted.
		"""
		try :
