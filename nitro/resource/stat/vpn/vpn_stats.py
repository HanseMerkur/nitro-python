...
class vpn_stats(base_resource) :
	...
	def iipfailedmipdisabled(self) :
		r"""Number of times IIP assignment failed and MIP is disabled.
		"""
		try :
	...
	def iipdisabledmipdisabled(self) :
		r"""Both IIP and MIP is disabled.
		"""
		try :
	...
	def iipspillovermipused(self) :
		r"""Number of times MIP is used on IIP Spillover.
		"""
		try :
	...
	def iipdisabledmipused(self) :
		r"""Number of times MIP is used as IIP is disabled.
		"""
		try :
	...
	def iipfailedmipused(self) :
		r"""Number of times MIP is used as IIP assignment failed.
		"""
		try :
