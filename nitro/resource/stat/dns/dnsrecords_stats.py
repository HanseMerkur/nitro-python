...
class dnsrecords_stats(base_resource) :
	...
	def dnsrecordtype(self) :
		r"""Display statistics for the specified DNS record or query type or, if a record or query type is not specified, statistics for all record types supported on the NetScaler appliance.
		"""
		try :
