...
class dos_stats(base_resource) :
	...
	def dostotvalidcookies(self) :
		r"""Number of clients from whom the NetScaler appliance received a valid DOS cookie.
		"""
		try :
	...
	def dostotconditiontriggered(self) :
		r"""Number of times the NetScaler appliance triggered the DOS JavaScript due to a condition match.
		"""
		try :
