...
class mediaclassification_stats(base_resource) :
	...
	@property
	def mcmp4vid(self) :
		r"""This tells the total number of MP4 videos served by NS.
		"""
		try :
	...
	def mcvideorate(self) :
		r"""Rate (/s) counter for mctotvideo.
		"""
		try :
	...
	@property
	def mc3pvid(self) :
		r"""This tells the total number of 3GP videos served by NS.
		"""
		try :
	...
	def mcencandroid(self) :
		r"""Total number of encrypted video streams requested by Android devices.
		"""
		try :
	...
	@property
	def mcflvvid(self) :
		r"""This tells the total number of FLV videos served by NS.
		"""
		try :
	...
	def mcunidentifiedrate(self) :
		r"""Rate (/s) counter for mcunidentified.
		"""
		try :
	...
	@property
	def mcencvideo(self) :
		r"""Total number of encrypted video streams.
		"""
		try :
	...
	def mclaptopdesktprate(self) :
		r"""Rate (/s) counter for mclaptopdesktp.
		"""
		try :
	...
	def mcyoutubedash(self) :
		r"""This tells the total number of YouTube DASH served by NS.
		"""
		try :
	...
	def mccaplelivestrmngvidrate(self) :
		r"""Rate (/s) counter for mccaplelivestrmngvid.
		"""
		try :
	...
	@property
	def mcenchls(self) :
		r"""Total number of encrypted AppleLive video streams.
		"""
		try :
	...
	def mcflvvidbytesrate(self) :
		r"""Rate (/s) counter for mcflvvidbytes.
		"""
		try :
	...
	def mcencvideorate(self) :
		r"""Rate (/s) counter for mcencvideo.
		"""
		try :
	...
	def mcadtsaudiobytes(self) :
		r"""This tells the total number of ADTS audio bytes served by NS .
		"""
		try :
	...
	def mcaacaudiobytesrate(self) :
		r"""Rate (/s) counter for mcaacaudiobytes.
		"""
		try :
	...
	def mccaplelivestrmngvid(self) :
		r"""This tells the total number of AppleLive videos served by NS.
		"""
		try :
	...
	def mcmssmthstrvidplrate(self) :
		r"""Rate (/s) counter for mcmssmthstrvidpl.
		"""
		try :
	...
	def mcapplelivestreamingvidbytesrate(self) :
		r"""Rate (/s) counter for mcapplelivestreamingvidbytes.
		"""
		try :
	...
	def mcyoutubedashbytesrate(self) :
		r"""Rate (/s) counter for mcyoutubedashbytes.
		"""
		try :
	...
	def mcmp4vidbytes(self) :
		r"""This tells the total number of MP4 video bytes served by NS .
		"""
		try :
	...
	def mcmssmthstrmvidbytesrate(self) :
		r"""Rate (/s) counter for mcmssmthstrmvidbytes.
		"""
		try :
	...
	def mc3gpvidbytesrate(self) :
		r"""Rate (/s) counter for mc3gpvidbytes.
		"""
		try :
	...
	def mcaudiorate(self) :
		r"""Rate (/s) counter for mctotaudio.
		"""
		try :
	...
	def mcyoutubedashbytes(self) :
		r"""This tells the total number of YouTube DASH bytes served by NS .
		"""
		try :
	...
	def mcmp4vidbytesrate(self) :
		r"""Rate (/s) counter for mcmp4vidbytes.
		"""
		try :
	...
	def mccapplelivestrmngvidplrate(self) :
		r"""Rate (/s) counter for mccapplelivestrmngvidpl.
		"""
		try :
	...
	def mctoherrate(self) :
		r"""Rate (/s) counter for mctotother.
		"""
		try :
	...
	def mcmssmthstrmplvidbytesplrate(self) :
		r"""Rate (/s) counter for mcmssmthstrmplvidbytespl.
		"""
		try :
	...
	def mccapplelivestrmngvidpl(self) :
		r"""This tells the total number of AppleLive Playlist served by NS.
		"""
		try :
	...
	def mcencandroidrate(self) :
		r"""Rate (/s) counter for mcencandroid.
		"""
		try :
	...
	def mcmssmthstrmvid(self) :
		r"""This tells the total number of Microsoft SmoothStreaming videos served by NS.
		"""
		try :
	...
	@property
	def mcencdash(self) :
		r"""Total number of encrypted Youtube DASH video streams.
		"""
		try :
	...
	def mcandroidrate(self) :
		r"""Rate (/s) counter for mcandroid.
		"""
		try :
	...
	def mcaacaudiorate(self) :
		r"""Rate (/s) counter for mcaacaudio.
		"""
		try :
	...
	def mcencdashrate(self) :
		r"""Rate (/s) counter for mcencdash.
		"""
		try :
	...
	def mcmssmthstrmvidbytes(self) :
		r"""This tells the total number of Microsoft SmoothStreaming video bytes served by NS .
		"""
		try :
	...
	@property
	def mcencios(self) :
		r"""Total number of encrypted video streams requested by IOS devices.
		"""
		try :
	...
	def mcadtsaudiorate(self) :
		r"""Rate (/s) counter for mcadtsaudio.
		"""
		try :
	...
	@property
	def mcaacaudio(self) :
		r"""This tells the total number of AAC audios served by NS.
		"""
		try :
	...
	def mcencotherrate(self) :
		r"""Rate (/s) counter for mcencother.
		"""
		try :
	...
	def mcapplelivestreamingplaylistvidbytesplrate(self) :
		r"""Rate (/s) counter for mcapplelivestreamingplaylistvidbytespl.
		"""
		try :
	...
	def mcmssmthstrvidpl(self) :
		r"""This tells the total number of Microsoft SmoothStreaming playlist served by NS.
		"""
		try :
	...
	def mcmssmthstrmvidrate(self) :
		r"""Rate (/s) counter for mcmssmthstrmvid.
		"""
		try :
	...
	def mcyoutubedashrate(self) :
		r"""Rate (/s) counter for mcyoutubedash.
		"""
		try :
	...
	def mcapplelivestreamingvidbytes(self) :
		r"""This tells the total number of AppleLive video bytes served by NS .
		"""
		try :
	...
	def mcadtsaudiobytesrate(self) :
		r"""Rate (/s) counter for mcadtsaudiobytes.
		"""
		try :
	...
	def mcmssmthstrmplvidbytespl(self) :
		r"""This tells the total number of Microsoft SmoothStreaming playlist bytes served by NS .
		"""
		try :
	...
	def mcadtsaudio(self) :
		r"""This tells the total number of ADTS audios served by NS.
		"""
		try :
	...
	@property
	def mcencother(self) :
		r"""Total number of encrypted video streams requested by non-Android and non-IOS devices.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all mediaclassification_stats resources that are configured on netscaler.
		"""
		try :
