...
class ssl_stats(base_resource) :
	...
	def ssltotoffloaddhkeyexchanges(self) :
		r"""Number of DH key exchanges offloaded to the cryptography card.d.
		"""
		try :
	...
	def sslcryptoutilizationstat(self) :
		r"""Utilization of the hardware crypto resource. Only valid values are 0-100%. Only works for platform with N3 chips.
		"""
		try :
	...
	def ssltotswdecbe(self) :
		r"""Number of bytes decrypted in software on back-end.
		"""
		try :
